...
import MaminSnack from "./MaminSnack";
...
function Copyright() {
  return (
    <Typography
      ...
      sx={{ flexGrow: 1, alignContent: "end", mb: 2 }}
    >
      {"Copyright © "}
...
export default function Footer() {
  ...
  const onSubmit = (data) => {
    ...
    Axios.get(
      `https://api.maminaudio.com/wp-json/my/v1/newsletter/1?email=${data.email}`
    )
      .then((res) => {
      ...
      >
        ...
        >
          ...
          <Box sx={{ width: { xs: "100%", sm: "60%" }, py: 10 }}>
            <img
              width="124px"
              src="static/images/footer/lileGirl.svg"
              style={{
                position: "absolute",
                bottom: 0,
              }}
        ...
        >
          ...
          >
            ...
            <Button
              ...
              sx={{ px: 8, mb: 2, mt: 2 }}
              startIcon={
                <MailOutlineIcon sx={{ color: "white" }} color="success" />
              }
            >
              Subscribe
            </Button>
